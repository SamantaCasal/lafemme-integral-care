    ...
    <footer className="bg-card border-t border-border">
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-lg font-semibold text-foreground">{t("footer.links")}</h4>
            <nav className="flex flex-col gap-2">
              {[
                { labelKey: "footer.specialties", href: "/especialidades" },
                { labelKey: "footer.book", href: "/turnos" },
                { labelKey: "blog.title", href: "/blog" },
                { labelKey: "footer.testimonials", href: "/testimonios" },
                { labelKey: "footer.faq_label", href: "/faq" },
              ].map((link) => (
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-lg font-semibold text-foreground">{t("footer.contact")}</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-lg font-semibold text-foreground">{t("footer.legal")}</h4>
            <nav className="flex flex-col gap-2 text-sm text-muted-foreground">
              <Link to="/faq" className="hover:text-primary transition-colors">{t("footer.privacy")}</Link>
              <Link to="/faq" className="hover:text-primary transition-colors">{t("footer.terms")}</Link>
            </nav>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-border">
          <p className="text-xs text-muted-foreground text-center leading-relaxed">
            © {new Date().getFullYear()} La Femme. {t("footer.copyright")}
          </p>
        </div>
      </div>
    </footer>
