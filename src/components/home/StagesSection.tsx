...
const stages = [
  {
    icon: Baby,
    title: "Embarazo",
    description: "Te acompañamos desde el inicio con preparación al parto, nutrición, ejercicios y contención emocional para vivir un embarazo pleno.",
    link: "/especialidades",
  },
  {
    icon: Heart,
    title: "Posparto",
    description: "Recuperación integral: evaluación postparto, lactancia, reeducación del piso pélvico y apoyo psicológico para esta nueva etapa.",
    link: "/especialidades",
  },
  {
    icon: Flower2,
    title: "Menopausia",
    description: "Un espacio sin tabúes para transitar la menopausia con bienestar, acompañamiento médico, nutricional y emocional.",
    link: "/especialidades",
  },
];
